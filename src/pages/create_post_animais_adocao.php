...
if(isset($_POST['upload_image_btn'])){
    ...
    //criar o post
    $stmt = $conn->prepare("INSERT INTO posts_animais_adocao (user_id,guards,image,date,username,nome_pet,raca,sexo,idade_pet,descricao)
                            VALUES (?,?,?,?,?,?,?,?,?,?)");
    $stmt->bind_param("iissssssss",$id,$guards,$image_name,$date,$username,$nome_pet,$raca,$sexo,$idade,$descricao);
