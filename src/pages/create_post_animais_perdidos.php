...
if(isset($_POST['upload_image_btn'])){
    ...
    //criar o post
    $stmt = $conn->prepare("INSERT INTO posts_animais_perdidos (user_id,guards,image,date,username,profile_image,nome_pet,raca,sexo,idade_pet,descricao,data_que_perdeu)
                            VALUES (?,?,?,?,?,?,?,?,?,?,?,?)");
    $stmt->bind_param("iissssssssss",$id,$guards,$image_name,$date,$username,$profile_image,$nome_pet,$raca,$sexo,$idade,$descricao,$data_perdeu);
