    ...
    <section class="profile">
      ...
      <div class="pet">
        <div class="avatar">
          ...
          <div class="status">
            <img src="../images/svg/status.svg" alt=""> <span>Adoção</span>
          </div>
        </div>
      </div>

      <a class="find-pet" target="_blank" href="https://wa.me/55DDDXXXXXXXXX">Estou interessado!</a>
    </section>
