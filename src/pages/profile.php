      ...
      <section class="profile-container">
          ...
          <section class="profile">
              <section class="profile-image">
                  <img src="<?php echo "../../img/imagens_usuarios/".$_SESSION['image'];  ?>" alt="Adicionar Foto" width="50" height="50">
              </section>
              <section class="profile-user-settings">
                  <img src="<?php echo "Foto:" ?><?php echo "../../img/imagens_usuarios/".$_SESSION['image'];  ?>" alt="">
